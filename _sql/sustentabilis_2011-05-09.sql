...
# Generation Time: 2011-05-11 02:43:21 -0500
# ************************************************************
...
VALUES
	(1,0,'carpeta1','Carpeta 1',1299046965);
...
VALUES
	(1,1,1,'i','Isa1','cumple_isa_2011_028.jpg','Cumple Isa','.jpg','image/jpeg',480,360,55,1299047019);
...
INSERT INTO `galleries` (`id`,`title`,`slug`,`thumbnail_id`,`description`,`parent`,`updated_on`,`preview`,`enable_comments`,`published`)
VALUES
	(2,'Galeria 1','galeria-1',1,'galeria 1',0,1299044848,NULL,0,1);
...
INSERT INTO `gallery_images` (`id`,`gallery_id`,`filename`,`extension`,`title`,`description`,`uploaded_on`,`updated_on`,`order`)
VALUES
	(1,2,'cumple_isa_2011_028','.jpg','test 5','',1299044861,1299047509,0);
...
VALUES
	(1,'Inicio','page',1,'','','',1,1,'',''),
	(2,'Productos','uri',0,'','','divisiones',1,2,'',''),
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='News Categories';

LOCK TABLES `news_categories` WRITE;
/*!40000 ALTER TABLE `news_categories` DISABLE KEYS */;
INSERT INTO `news_categories` (`id`,`slug`,`title`)
VALUES
	(4,'cat1','cat1');
...
VALUES
	(1,'Default','{pyro:page:test}{pyro:page:body}','','default.html',1299048839);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='User Editable Pages';
...
VALUES
	(1,'home','Inicio',0,'10','1','','function init() {               \n        // options\n        var o = {\n          enableMouse: false,\n          childSizeFixed:true\n        };\n        // Setup galleries\n        $(\".myJac\").jac(o);  \n      }\n          \n      $(init); // on DOM ready','','','',0,0,'live',1298609574,1298616276),
...
VALUES
	(1,'dev@palmea.net','36a00bba9d95814a2bbd6f64d29373a793a59287','228cb',1,'',1,'',1298447728,1304838268,'admin',NULL,NULL);
...
VALUES
	(1,'unsorted','Unsorted'),
	(2,'nav_divisiones','nav_divisiones');
...
INSERT INTO `widget_instances` (`id`,`title`,`widget_id`,`widget_area_id`,`options`,`order`,`created_on`,`updated_on`)
VALUES
	(1,'Navegación',5,2,'a:1:{s:5:\"group\";s:6:\"header\";}',1,1299044199,1299044199);
